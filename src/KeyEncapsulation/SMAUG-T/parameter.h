...
#define CRYPTO_SMAUG_T_MAX_PUBLIC_KEY_BYTES \
    LIBERAC_SMAUG_T_256_PUBLIC_KEY_BYTES
#define CRYPTO_SMAUG_T_MAX_PRIVATE_KEY_BYTES \
    LIBERAC_SMAUG_T_256_PRIVATE_KEY_BYTES
#define CRYPTO_SMAUG_T_MAX_CIPHERTEXT_BYTES \
    LIBERAC_SMAUG_T_256_CIPHERTEXT_BYTES
...
static const crypto_smaug_t_parameters CRYPTO_SMAUG_T_PARAMETER_SETS[] = {
    {
        LIBERAC_ALG_SMAUG_T_128,
        2u, 10u, 8u, 5u, 70u,
        UINT16_C(0x0080), UINT16_C(0xff00),
        UINT16_C(0x0400), UINT16_C(0xf800),
        96u, 320u, 256u, 160u, 512u, 128u,
        LIBERAC_SMAUG_T_128_PUBLIC_KEY_BYTES,
        LIBERAC_SMAUG_T_128_PRIVATE_KEY_BYTES,
        LIBERAC_SMAUG_T_128_CIPHERTEXT_BYTES
    },
    {
        LIBERAC_ALG_SMAUG_T_192,
        3u, 11u, 9u, 4u, 88u,
        UINT16_C(0x0040), UINT16_C(0xff80),
        UINT16_C(0x0800), UINT16_C(0xf000),
        64u, 352u, 288u, 128u, 864u, 192u,
        LIBERAC_SMAUG_T_192_PUBLIC_KEY_BYTES,
        LIBERAC_SMAUG_T_192_PRIVATE_KEY_BYTES,
        LIBERAC_SMAUG_T_192_CIPHERTEXT_BYTES
    },
    {
        LIBERAC_ALG_SMAUG_T_256,
        4u, 11u, 9u, 7u, 87u,
        UINT16_C(0x0040), UINT16_C(0xff80),
