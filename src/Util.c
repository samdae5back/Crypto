...
/* ------------------------------------------------------------------------- */
/* Shared private bignum fast/secret helpers.                                 */
/*                                                                           */
/* These live in the already-built utility translation unit so the helpers   */
/* remain shared without adding another build-system source entry.           */
/* ------------------------------------------------------------------------- */
